    ...
    %>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
            	<%if (logName == null){ %>
                <div class="sidebar-heading border-bottom bg-light">당신은! ※Guest※</div>
                <%}else{ %>
                <div class="sidebar-heading border-bottom bg-light">안녕 ★<%=logName %>★</div>
                <%} %>
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="boardList.do">글 목록</a>
                    <% if (logId == null){ %>  <!--  null이라는 건 로그인 안한 것.  -->
